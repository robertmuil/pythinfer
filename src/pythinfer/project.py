...
def _get_sentinel_project_file() -> Path:
    """Return a sentinel value used for the project file when generated by code."""
    return Path.cwd() / "generated_by_code.nonexistent"
...
class ProjectSpec(BaseModel):
    ...
    the current working directory because this path is used to determine where the
